...
void test_init_sprite_param(sprite_t *sprite, int x, int y, int w, int h, int vv, int vh, int visible)
{
    init_sprite(sprite, x, y, w, h, vv, vh, visible);
    print_sprite(sprite);
}
void test_init_sprite()
{
    world_t world;
    init_data(&world);
    test_init_sprite_param(&world.missile, 500, 15, 28, 440, 5,12, 1);
    test_init_sprite_param(&world.missile, 100, 10, 10, 2, 4, 8, 1);
    test_init_sprite_param(&world.missile, 500, 140, 280, 15, 12, 25, 1);
    test_init_sprite_param(&world.missile, 0, 0, 0, 0, 0, 0, 1);
